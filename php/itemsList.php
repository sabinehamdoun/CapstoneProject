			...
			<div class="row">
				...
				<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
					...
					<div class="widget dashboard-container my-adslist">
						<h3 class="widget-header">Items List</h3>
									...
									<td class="action" data-title="Action">
										<div class="">
											<ul class="list-inline justify-content-center">
												...
												<form action="../php/singleAdmin.php" method="post" class="view">
												...
												<li class="list-inline-item">
													<form action="../php/adminUpdateAdd.php" method="post">
														<input type="hidden" name="_id" value="' . $searchfor["_id"] . '">
														<button name="update" type="submit">
												...
												<li class="list-inline-item">
													<form action="../php/deleteMyAdd.php" method="post">
														<input type="hidden" name="noteId" value="' . $searchfor["_id"] . '">
