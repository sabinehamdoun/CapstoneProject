					...
					<div class="row mt-30">
						<div class="col-sm-12 col-lg-4 col-md-6">
							...
							foreach ($result as $searchfor) {
								/*echo '<form action="../php/addToFavorite.php" method="post">
										<input type="hidden" name="_id" value="' . $searchfor["_id"] . '">
										<button name="favorite" type="submit">
										<i class="fa fa-heart"></i>
										</button>
							  		</form>
									<form action="../php/single.php" method="post"><input type="hidden" name="_id" value="' . $searchfor["_id"] . '"><div class="product-item bg-light"><button name="update" type="submit"><div class="card">
										...
										<div class="card-body">
											<h4 class="card-title"><a href="">' . $searchfor['title'] . '</a></h4>
