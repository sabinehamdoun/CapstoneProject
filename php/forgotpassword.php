    ...
    <main>
        <div class="row-login">
            <div class="colm-logo">
                ...
                <h2 id="loginh2">ClassiMax is an advertisement site for books, stationery, courses, and teachers. Find what you're searching for or make your very own advertisement for nothing!</h2>
            </div>
            <div class="colm-form">
                <div class="form-container">
                    ...
                    <form action="../php/resetpassword.php" method="post">
                        ...
                        <input required type="email" id="email" placeholder="Email Address" name="email" pattern="^([A-Za-z]{1})+([A-Za-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,}+$">

                        <!--<input type="password" placeholder="Password" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$" name="Pass">-->
