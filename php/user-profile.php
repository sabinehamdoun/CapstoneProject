			...
			<div class="row">
					...
					<div class="sidebar">
						...
						<div class="widget user-dashboard-menu">
							<ul>
								...
								<li>
									<a href="../php/dashboard-favourite-ads.php"><i class="fa fa-bookmark-o"></i> Favourite Ads <span>5</span></a>
								</li>
								<!--<li>
				...
				<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
					...
					<div class="widget personal-info">
						...
						<form action="../php/editpersonalinformation.php" method="POST" enctype="multipart/form-data">
							<!-- First Name -->
