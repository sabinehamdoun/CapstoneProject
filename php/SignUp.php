    ...
    <div class="row-login">
      ...
      <div class="colm-form">
        <div class="form-container">
          ...
          <form action="../php/insertUsers.php" method="post" enctype="multipart/form-data">
            ...
            <input required type="number" placeholder="Age" name="age" min="10" max="65" pattern="/^([1-9]|[1-5][0-9]|6[0-5])$/">
            ...
            <input required type="file" name="myimage" id="myimage">
