                    ...
                    <div class="block comment">
                        ...
                        <form action="../php/admin.php" method="post">
                            ...
                            <div class="form-group mb-30">
                                <textarea class="form-control" id="adminNote" name="adminNote" rows="8"></textarea>
                            </div>
                            <!--<div class="row">
                            ...
                            <button class="btn btn-transparent">Leave Note</button>
                        </form>
                    ...
                    <div class="sidebar">
                        <div class="widget search p-0">
                            <form action="../php/searchforproduct.php" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="itemSearch" placeholder="Search for product" name="itemSearch">
                        ...
                        <div class="widget category">
                            ...
                            <ul class="category-list">
                                <li><a href="../php/Books.php">Books <span class="float-right"><?php echo "(" . $countBooks . ")"; ?></span></a></li>
                                <li><a href="../php/Stationary.php">Stationery <span class="float-right"><?php echo "(" . $countStationary . ")"; ?></span></a></li>
                                <li><a href="../php/Electronics.php">Electronics <span class="float-right"><?php echo "(" . $countElectronics . ")"; ?></span></a></li>
                                <li><a href="../php/Courses.php">Courses <span class="float-right"><?php echo "(" . $countCourses . ")"; ?></span></a></li>
                                <li><a href="../php/Teachers.php">Teachers <span class="float-right"><?php echo "(" . $countTeachers . ")"; ?></span></a></li>
                            </ul>
                        </div>
