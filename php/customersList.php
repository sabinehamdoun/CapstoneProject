...
$collection5 = $db->selectCollection($tableName);
$countFavorites = $collection5->count();
$collection = $db->users;
			...
			<div class="row">
				<div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
					<div class="sidebar">
						...
						<div class="widget user-dashboard-profile">
							...
							<a href="../php/admin-profile.php" class="btn btn-main-sm">Edit Profile</a>
						</div>
						<!-- Dashboard Links -->
						<!--<div class="widget user-dashboard-menu">
							<ul>
								<li class="active">
									<a href="../php/dashboard-my-ads.php"><i class="fa fa-user"></i> My Ads</a>
								</li>
								<li>
				...
				<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
					...
					<div class="widget dashboard-container my-adslist">
						<h3 class="widget-header">Customers List</h3>
							...
							<tbody>
								...
								foreach ($result as $searchfor) {
									...
									<td class="product-thumb">
										<img width="80px" height="auto" src="data:image/jpeg;base64,' . $searchfor['myimage'] . '"/>
									</td>
									<td class="product-details">
										<h3 class="title">' . $searchfor['firstname'] . " " . $searchfor['lastname'] . '</h3>
										<span><strong>Email</strong><time><a href="mailto:'.$searchfor['email'].'">'.$searchfor['email'].'</a></time> </span>
										<span class="status active"><strong>Phone</strong>' . $searchfor['phonenumber'] . '</span>
										<span class="location"><strong>Age</strong>' . $searchfor['age'] . '</span>
										<span class="price"><strong>City</strong>' . $searchfor['city'] . '</span>
									</td>
